...
alias rr-ngconfig="st /usr/local/etc/nginx/nginx.conf"
...
alias rr-st="open $HOME/Library/Application\ Support/Sublime\ Text\ 3/st3-sync.sublime-project"
alias rr-stcd="cd $HOME/Library/Application\ Support/Sublime\ Text\ 3"
alias rr-stsnippets="st $HOME/Library/Application\ Support/Sublime\ Text\ 3/Packages/User/Snippets"
