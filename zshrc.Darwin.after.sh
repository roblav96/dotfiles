...
alias denon-avr="curl --insecure 'https://192.168.2.119:10443/ajax/general/get_config?type=12' | oq -i xml -o yaml '.Information' | bat --style=grid -l yml"
alias denon-avr-device-info="curl http://192.168.2.119:8080/goform/Deviceinfo.xml | oq -i xml -o yaml | bat --style=grid -l yml"
