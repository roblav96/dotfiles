...
alias denonavr="curl --insecure 'https://192.168.1.3:10443/ajax/general/get_config?type=12' | oq -i xml -o yaml '{Zone:.Information.Zone,Video:.Information.Video,Audio:.Information.Audio}' | pb yaml"
alias denonavr-device-info="curl http://192.168.1.3:8080/goform/Deviceinfo.xml | oq -i xml -o yaml | pb yaml"
