...
alias lrr="exa --all --long --header --classify --group --modified --color-scale --icons --recurse --tree --level=3 --ignore-glob='.git|.DS_Store|node_modules'"
alias lrrr="exa --all --long --header --classify --group --modified --color-scale --icons --recurse --tree --level=4 --ignore-glob='.git|.DS_Store|node_modules'"
alias lrrrr="exa --all --long --header --classify --group --modified --color-scale --icons --recurse --tree --level=5 --ignore-glob='.git|.DS_Store|node_modules'"
