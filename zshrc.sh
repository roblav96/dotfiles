...
alias lsd="lsd -laF --icon=never --date=relative --ignore-glob=.git --ignore-glob=.DS_Store"
alias lsdr="lsd -laF --icon=never --date=relative --ignore-glob=.git --ignore-glob=.DS_Store --ignore-glob=node_modules --tree --depth=2"
alias lsdra="lsd -laF --icon=never --date=relative --ignore-glob=.git --ignore-glob=.DS_Store --ignore-glob=node_modules --tree"
...
alias aria2dl="aria2c --disable-ipv6 --timeout=5 --split=4 --max-concurrent-downloads=4 --max-connection-per-server=4 --min-split-size=1M --file-allocation=none --download-result=full"
