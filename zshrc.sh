...
if test -x "$(which exa)"; then
	...
	alias l="exa $EXA_OPTS --git-ignore --ignore-glob='.git|.DS_Store|node_modules'"
	...
	alias lb="exa $EXA_OPTS --git-ignore --ignore-glob='.git|.DS_Store|node_modules' --sort=size"
	alias lab="exa $EXA_OPTS --group --sort=size"
	alias lm="exa $EXA_OPTS --git-ignore --ignore-glob='.git|.DS_Store|node_modules' --sort=modified"
	alias lam="exa $EXA_OPTS --group --sort=modified"
	alias lac="exa $EXA_OPTS --git-ignore --ignore-glob='.git|.DS_Store|node_modules' --accessed --sort=accessed"
	alias laac="exa $EXA_OPTS --group --accessed --sort=accessed"
fi
