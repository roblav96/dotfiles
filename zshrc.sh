...
alias lsd="lsd --color=auto --icon=never --date=relative --size=short -lAF --ignore-glob=.git --ignore-glob=.DS_Store"
alias lsdr="lsd --color=auto --icon=never --date=relative --size=short -lAF --ignore-glob=.git --ignore-glob=.DS_Store --ignore-glob=node_modules --tree --depth=2"
alias lsdra="lsd --color=auto --icon=never --date=relative --size=short -lAF --ignore-glob=.git --ignore-glob=.DS_Store --ignore-glob=node_modules --tree"
...
alias bak='[[ -d ~/.playground/"$(basename "$PWD").$(dateiso)" ]] && rd ~/.playground/"$(basename "$PWD").$(dateiso)"; mkdir ~/.playground/"$(basename "$PWD").$(dateiso)" && f --no-ignore -d1 -X cp -r -t ~/.playground/"$(basename "$PWD").$(dateiso)"'
