...
alias lsd="lsd --color=auto --icon=never --date=relative -lAF --ignore-glob=.git --ignore-glob=.DS_Store"
alias lsdr="lsd --color=auto --icon=never --date=relative -lAF --ignore-glob=.git --ignore-glob=.DS_Store --ignore-glob=node_modules --tree --depth=2"
alias lsdra="lsd --color=auto --icon=never --date=relative -lAF --ignore-glob=.git --ignore-glob=.DS_Store --ignore-glob=node_modules --tree"
...
if [[ "$PLATFORM" == "Linux" ]]; then
	alias pcsa='procs --nor "$(upiso | head -c-3)" "kworker/" "jfs" "xfs"'
