...
alias lmra="exa --all --long --header --classify --group --modified --color-scale --icons --recurse --tree --ignore-glob='.git|node_modules' --sort=modified"
alias lmraa="exa --all --long --header --classify --group --modified --color-scale --icons --recurse --tree --ignore-glob='.git' --sort=modified --extended"
alias lb="exa --all --long --header --classify --group --modified --color-scale --icons --sort=size"
alias lbr="exa --all --long --header --classify --group --modified --color-scale --icons --recurse --tree --level=2 --ignore-glob='.git|node_modules' --sort=size"
