...
alias bat="bat --color=always --italic-text=always --decorations=always --paging=never --wrap=always --style='header,grid,numbers' --tabs=4 --theme='Monokai Extended Origin'"
alias b='bat'
