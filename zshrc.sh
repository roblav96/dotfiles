...
if test -x "$(which exa)"; then
	...
	alias lb="exa $EXA_OPTS --ignore-glob='.git|.DS_Store|node_modules' --git-ignore --sort=size"
	alias lab="exa $EXA_OPTS --ignore-glob='.git|.DS_Store' --group --sort=size"
	alias lm="exa $EXA_OPTS --ignore-glob='.git|.DS_Store|node_modules' --git-ignore --sort=modified"
	alias lam="exa $EXA_OPTS --ignore-glob='.git|.DS_Store' --group --sort=modified"
	alias lac="exa $EXA_OPTS --ignore-glob='.git|.DS_Store|node_modules' --git-ignore --accessed --sort=accessed"
	alias laac="exa $EXA_OPTS --ignore-glob='.git|.DS_Store' --group --accessed --sort=accessed"
fi
