...
function batlangs() {
	...
	if [[ $# -eq 0 ]]; then
		...
		langs=("ActionScript" "AppleScript" "AWK" "Bourne Again Shell (bash)" "CMake" "CMakeCache" "CpuInfo" "Erlang" "F#" "Friendly Interactive Shell (fish)" "fstab" "Generic Config" "Git Attributes" "Groovy" "group" "Haskell" "INI" "Java Properties" "Java" "Julia" "Kotlin" "Lisp" "Lua" "Makefile" "Manpage" "MemInfo" "Nim" "Nix" "OCaml" "Pascal" "Perl" "Python" "QML" "Ruby" "Strace" "Stylus" "Swift" "Tcl" "TOML" "TypeScriptReact" "Verilog" "VimL" "YAML")
	fi
