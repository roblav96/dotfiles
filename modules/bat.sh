...
function batlangs() {
	...
	local langs=('ActionScript' 'AppleScript' 'AWK' 'Bash' 'Erlang' 'F#' 'Generic Config' 'Haskell' 'INI' 'Julia' 'Kotlin' 'Lua' 'Nim' 'Nix' 'OCaml' 'Pascal' 'Perl' 'Python' 'QML' 'Ruby' 'Strace' 'Stylus' 'Swift' 'Tcl' 'TOML' 'Verilog' 'YAML')
