...
alias bat="command bat $BAT_FLAGS --style=header,grid"
...
function batlangs() {
	...
	# 	echo "🌕 BAT_LANG -> $BAT_LANG"
	# 	# $@ | bat --style=grid -l "$BAT_LANG"
	# done
}
