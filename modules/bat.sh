...
function batlangs() {
	...
	local langs=('ActionScript' 'AppleScript' 'AWK' 'Bash' 'CMake' 'Erlang' 'F#' 'Generic Config' 'Haskell' 'INI' 'Julia' 'Kotlin' 'Lisp' 'Lua' 'Makefile' 'Nim' 'Nix' 'OCaml' 'Pascal' 'Perl' 'Python' 'QML' 'Ruby' 'Strace' 'Stylus' 'Swift' 'Tcl' 'TOML' 'Verilog' 'YAML')
