export RG_FLAGS="--color=always --heading --line-number --trim --no-messages --smart-case --hidden --fixed-strings --max-columns-preview --max-columns=\$(expr \$(tput cols) - 25) --glob='!.git' --glob='!.DS_Store'"
...
alias rgp="rg --color=always --passthru --ignore-case --fixed-strings"
