...
alias adbl="adb shell /data/local/tmp/bin/lsd --color=always --icon=never --date=relative --size=short --header -lAF"
...
--message '!^SecureHdcp_GetCurrentLevel: cur: 0x04, max: 0x04$' \
--message '! OEMCrypto_Generic_' \
\
