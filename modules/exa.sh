...
alias lchanged="exa $EXA_FLAGS --time=changed --sort=changed"
alias laccessed="exa $EXA_FLAGS --time=accessed --sort=accessed"
alias lcreated="exa $EXA_FLAGS --time=created --sort=created"
