...
alias la="exa $EXA_FLAGS --extended --links"
alias lar="exa $EXA_FLAGS --extended --links --tree --recurse --level=2"
alias larr="exa $EXA_FLAGS --extended --links --tree --recurse --level=3"
