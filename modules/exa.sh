...
alias lstb="exa $EXA_FLAGS --sort=size"
alias lstm="exa $EXA_FLAGS --time=modified --sort=modified"
alias lstch="exa $EXA_FLAGS --time=changed --sort=changed"
alias lstac="exa $EXA_FLAGS --time=accessed --sort=accessed"
alias lstcr="exa $EXA_FLAGS --time=created --sort=created"
