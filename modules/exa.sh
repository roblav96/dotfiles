...
alias lar="exa $EXA_FLAGS --tree --level=2"
alias larr="exa $EXA_FLAGS --tree --level=3"
alias larrr="exa $EXA_FLAGS --tree --level=4"
alias larrrr="exa $EXA_FLAGS --tree --level=5"
alias lara="exa $EXA_FLAGS --tree"
