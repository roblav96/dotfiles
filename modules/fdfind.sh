...
if [[ "$PLATFORM" == "Linux" ]]; then
	alias fr="fd $FD_FLAGS_ALL --fixed-strings --absolute-path --base-directory=/ --exclude=$HOME/.npm --exclude=$HOME/.pnpm-store --exclude=$HOME/emby --exclude=$HOME/.linuxbrew --exclude=/proc --exclude=/sys --exclude=/var/www --exclude=/var/lib/emby/cache --exclude=/var/lib/emby/metadata"
fi
